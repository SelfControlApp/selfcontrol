...
- (BOOL)listener:(NSXPCListener *)listener shouldAcceptNewConnection:(NSXPCConnection *)newConnection {
    ...
    SecRequirementCreateWithString(CFSTR("anchor apple generic and (identifier \"org.eyebeam.SelfControl\" or identifier \"org.eyebeam.selfcontrol-cli\" or identifier \"com.application.SelfControl.corebits\") and info [CFBundleVersion] >= \"10\""), kSecCSDefaultFlags, &isSelfControlApp);
